...
#             plug_src = dgLib.DGNode(geo_name).plugs.get_plug("outMesh")
#             plug_src2 = dgLib.DGNode(geo_name).plugs.get_plug("worldMesh[0]")
#         elif (
#             geometry.apiType() == om.MFn.kNurbsSurface
#             or geometry.apiType() == om.MFn.kNurbsCurve
#         ):
#             plug_src = dgLib.DGNode(geo_name).plugs.get_plug("local")
#             plug_src2 = dgLib.DGNode(geo_name).plugs.get_plug("worldSpace[0]")
#
...
#
#         if geometry.apiType() == om.MFn.kMesh:
#             plug_dest = dgLib.DGNode(geo_name).plugs.get_plug("inMesh")
#         elif (
#             geometry.apiType() == om.MFn.kNurbsSurface
#             or geometry.apiType() == om.MFn.kNurbsCurve
#         ):
#             plug_dest = dgLib.DGNode(geo_name).plugs.get_plug("create")
#
