...
from ..plugs_lib import Plug
from .dg_lib import DGNode
...
class DAGNode(DGNode):
    ...
    @property
    def dagNode(self) -> om.MFnDagNode:
    ...
    def isDagNodeValid(self) -> bool:
        ...
        return self.dagNode.hasObj(self)
    ...
    def children(self) -> list:
        ...
        """
        items = []
        for idx in range(self.dagNode.childCount()):
            child_obj = self.dagNode.child(idx)
    ...
    def parents(self) -> list:
        ...
        """
        items = []
        for idx in range(self.dagNode.parentCount()):
            parent_obj = self.dagNode.parent(idx)
    ...
    @property
    def boundingBox(self) -> Optional[om.MBoundingBox]:

        """
        The bounding box of the current node

        Returns:
            Optional[om.MBoundingBox]: the bounding box of the current node
        """

        return self.dagNode.boundingBox
    ...
    def transformationMatrix(self) -> om.MMatrix:
        ...
        return self.dagNode.transformationMatrix()
