...
class Container(dg_lib.DGNode):
    ...
    def __publishedNodes(self, attr) -> Dict[str, dg_lib.DGNode]:
        """
    ...
    @property
    def publishedParentAnchor(self) -> Dict[str, dg_lib.DGNode]:
        """
    ...
    @property
    def publishedChildAnchor(self) -> Dict[str, dg_lib.DGNode]:
        """
    ...
    @property
    def publishedNodes(self) -> Dict[str, dg_lib.DGNode]:
        """
    ...
    @property
    def rootTransform(self) -> dg_lib.DGNode:

        """
        Get the root transform of the container

        Returns:
             dg_lib.DGNode, an instance of a subclass of Node
        """
