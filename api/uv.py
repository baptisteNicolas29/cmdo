...
def duplicateUVSet(source_obj, source_uv_set, new_uv_set):
    ...
    :param source_obj: the object to duplicate uv set on
    :param source_uv_set: the name of the uv set to duplicate
    :param new_uv_set: the name of the duplicated uv set
    """
...
def transferUVSets(source_obj, target_obj, keep_history=False):
    ...
    :param source_obj: the object with the uv set to transfer
    :param target_obj: the object to receive the uv set
    :param keep_history: whether to delete history or not
    """
